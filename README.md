...
- **Story table** — one row per story, sortable by airings/channels/countries/longevity/reach/publish date, with search and region/minimum-airings filters. Each row shows an inline trend sparkline of airings per day across the dataset window.
